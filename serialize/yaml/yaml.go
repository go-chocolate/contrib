...
func UseNumber() JSONOpt {
	return func(de *json.Decoder) *json.Decoder {
		de.UseNumber()
		return de
	}
}

func DisallowUnknownFields() JSONOpt {
	return func(de *json.Decoder) *json.Decoder {
...
func Unmarshal(y []byte, o interface{}) error {
	return unmarshal(yaml.Unmarshal, y, o, nil)
}

func UnmarshalOpts(y []byte, o interface{}, opts ...JSONOpt) error {
